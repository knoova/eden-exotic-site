...
export const knowledgeBase: Doc[] = [
  ...
  { id: "facility-allevamento-n2", categoria: "facility", titolo: "Allevamento N.2 — Iquitos, Perù",
    testo: "Allevamento di ragni (salticidi e tarantole) nell'Amazzonia peruviana. Percezione visiva distribuita e biomateriali di seta ad alte prestazioni. Tema «La Rete»; protocolli C e D; diretto dal Dr. Ricardo Vásquez Chávez. Stato proposto." },
  ...
  { id: "facility-laboratorio-n11", categoria: "facility", titolo: "Laboratorio N.11 — Nuova Caledonia, Francia",
    testo: "Ramo aviario proposto: uccelli (corvidi e pappagalli) per lo studio della comunicazione vocale, della mimica e della cognizione sociale. Tema «La Voce»; protocolli C e H; diretto dal Dr. Étienne Lefèvre. Stato proposto." },
